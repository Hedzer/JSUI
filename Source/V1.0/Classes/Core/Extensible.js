...
//Mixins
import Eventful from '/JSUI/Source/V1.0/Classes/Core/Eventful';
import ExtensibleMixin from '/JSUI/Source/V1.0/Mixins/Extensible';
...
exports(Extensible).as('/JSUI/Source/V1.0/Classes/Core/Extensible');
