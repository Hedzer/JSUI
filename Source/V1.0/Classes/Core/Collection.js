...
//Classes
import CollectionWhereReceipt from '/JSUI/Source/V1.0/Classes/Receipts/CollectionWhere';

//Constants
import $private from '/JSUI/Source/V1.0/Constants/Keys/General/private';

//Handlers
import Do from '/JSUI/Source/V1.0/Classes/Core/Collection/Handlers/Do';
import Get from '/JSUI/Source/V1.0/Classes/Core/Collection/Handlers/Get';
import getHandledType from '/JSUI/Source/V1.0/Classes/Core/Element/getHandledType';
import Set from '/JSUI/Source/V1.0/Classes/Core/Collection/Handlers/Set';
...
exports(Collection).as('/JSUI/Source/V1.0/Classes/Core/Collection');