...
import Styleable from '/JSUI/Source/V1.0/Classes/Core/Styleable';

//Handlers
import Add from '/JSUI/Source/V1.0/Classes/Core/Element/Handlers/Add';
import AddTo from '/JSUI/Source/V1.0/Classes/Core/Element/Handlers/AddTo';
import Attribute from '/JSUI/Source/V1.0/Classes/Core/Element/Handlers/Attribute';
import Class from '/JSUI/Source/V1.0/Classes/Core/Element/Handlers/Class';
import constructor from '/JSUI/Source/V1.0/Classes/Core/Element/Handlers/Constructor';
import Do from '/JSUI/Source/V1.0/Classes/Core/Element/Handlers/Do';
import Find from '/JSUI/Source/V1.0/Classes/Core/Element/Handlers/Find';
import Get from '/JSUI/Source/V1.0/Classes/Core/Element/Handlers/Get';
import getHandledType from '/JSUI/Source/V1.0/Classes/Core/Element/getHandledType';
import On from '/JSUI/Source/V1.0/Classes/Core/Element/Handlers/On';
import Remove from '/JSUI/Source/V1.0/Classes/Core/Element/Handlers/Remove';
import Set from '/JSUI/Source/V1.0/Classes/Core/Element/Handlers/Set';
import Text from '/JSUI/Source/V1.0/Classes/Core/Element/Handlers/Text';
import Trigger from '/JSUI/Source/V1.0/Classes/Core/Element/Handlers/Trigger';
import unhandled from '/JSUI/Source/V1.0/Classes/Core/Handlers/unhandled';
...
exports(Element).as('/JSUI/Source/V1.0/Classes/Core/Element');