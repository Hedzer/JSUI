...
import normalize from '/JSUI/Source/V1.0/Constants/Keys/BindReceipt/normalize';
import on from '/JSUI/Source/V1.0/Constants/Keys/BindReceipt/on';
import remove from '/JSUI/Source/V1.0/Constants/Keys/BindReceipt/remove';
import removeAll from '/JSUI/Source/V1.0/Constants/Keys/BindReceipt/removeAll';
import to from '/JSUI/Source/V1.0/Constants/Keys/BindReceipt/to';

//Handlers
import getHandledType from '/JSUI/Source/V1.0/Classes/Receipts/Bind/getHandledType';
import relationships from '/JSUI/Source/V1.0/Classes/Receipts/Bind/relationships';
...
import isRelationshipBindingReceipt from '/JSUI/Source/V1.0/TypeChecks/isRelationshipBindingReceipt';
...
exports(BindReceipt).as('/JSUI/Source/V1.0/Classes/Receipts/Bind');